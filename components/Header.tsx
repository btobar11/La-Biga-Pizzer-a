        ...
        >
            ...
            <div className="container mx-auto flex flex-col items-center justify-center gap-6 pointer-events-none relative -mt-10 md:-mt-14">
                ...
                <div className="relative flex items-center justify-center mt-2 md:mt-4 pointer-events-auto">
                    ...
                    <div className="relative h-28 w-28 md:h-64 md:w-64 shrink-0 overflow-hidden rounded-full shadow-2xl z-20 border-2 border-white/10 backdrop-blur-sm">
                        <Image
                            src="/logo.png"
                            alt="La Biga Logo"
                            fill
                    ...
                    {/* Mobile: 180px, Desktop: 340px */}
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[180px] h-[180px] md:w-[340px] md:h-[340px] z-10 pointer-events-none">
